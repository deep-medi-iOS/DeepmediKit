...
//    
//    private let measurementFileWriter = MeasurementFileWriter(),
//                measurementState = MeasurementState(),
//                notiGenerator = UINotificationFeedbackGenerator()
//    
//    private let model       = FaceKitConfigurationStore.shared,
//                cameraSessionManager = CameraSessionManager.shared
//    
//    private let device = UIDevice.current
//    
//    // MARK: property
//    private var tap = [MeasurementState.status](),
//                noTap = [MeasurementState.status](),
//                stopMeasureStatus = [MeasurementState.status]()
//    
...
//    ) {
//        let ratio = measurementState.measurementCompleteRatio
//        ratio
//            .asDriver(onErrorJustReturn: "0%")
//            .asDriver()
...
//    ) {
//        let completion = measurementState.fingerMeasurementComplete
//        completion
...
//        } else if measurementState.stoppedByFlipingDevice {
...
//    ) {
//        let value = measurementState.inputFilteringGvalue
//        value
//            .observe(on: MainScheduler.asyncInstance)
//            .asDriver(onErrorJustReturn: 0)
...
//            cameraSessionManager.useSession().startRunning()
...
//        isComplete = true
//        cameraSessionManager.useCaptureDevice().exposureMode = .autoExpose
...
//        torch: Bool
//    ) {
//        guard cameraSessionManager.hasTorch() else {
//            print("has not torch")
//            return
//        }
//        
//        switch torch {
//            case true:
//                cameraSessionManager.useCaptureDevice().torchMode = .on
//            case false:
//                cameraSessionManager.useCaptureDevice().torchMode = .off
//        }
//    }
//    
//    /// Accelemeter start
...
//                forward = !back
//            
//            measurementState.inputAccZback.onNext(back)
//            measurementState.inputAccZforward.onNext(forward)
//        }
//    }
//    
//    private func measurementRGBfromFinger() {
//        let status = measurementState.outputFingerStatus
//        status
...
//        let completion               = measurementState.fingerMeasurementComplete,
//            secondRemaining          = measurementState.secondRemaining,
//            measurementCompleteRatio = measurementState.measurementCompleteRatio
//        
//        isComplete = true
//        initRGBData()
//        initAccData()
...
//                  let rgbPath = self.measurementFileWriter.make(data: .rgb, dataSet: totalData) else {
...
//                if let accPath  = self.measurementFileWriter.make(data: .acc, dataSet: accData),
//                    let gyroPath = self.measurementFileWriter.make(data: .gyro, dataSet: gyroData) {
//                    completion.onNext(
//                        (
//                            success: true,
//                            rgbURL:  rgbPath,
